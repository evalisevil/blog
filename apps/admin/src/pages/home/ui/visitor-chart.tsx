    ...
    <Card className="@container/card">
      <CardHeader>
        ...
        <CardAction>
          ...
          >
            <ToggleGroupItem className="text-xs cursor-pointer" value="90d">
              지난 3개월
            </ToggleGroupItem>
            <ToggleGroupItem className="text-xs cursor-pointer" value="30d">
              지난 30일
            </ToggleGroupItem>
            <ToggleGroupItem className="text-xs cursor-pointer" value="7d">
              지난 7일
            </ToggleGroupItem>
          </ToggleGroup>
